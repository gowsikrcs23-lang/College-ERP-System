...
router.get('/stats', auth, authorize('faculty', 'admin', 'management'), getAttendanceStats);
router.get('/student/:studentId', auth, getAttendanceByStudent);
router.get('/class', auth, authorize('faculty', 'admin', 'management'), getAttendanceByClass);
