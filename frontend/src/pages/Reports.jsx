            ...
            reports.map((report) => (
              <div key={report._id} className="flex justify-between items-center p-4 border rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-600">{report.reportType} - Semester {formatSemester(report.semester)} ({report.academicYear})</p>
            ...
            <div key={report._id} className="card">
              ...
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Semester {formatSemester(report.semester)} - {report.academicYear}</p>
                </div>
